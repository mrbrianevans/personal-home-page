...
$pageName = "Current Meter Calibration Calculator";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <script src="currentMeter.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://use.typekit.net/rwv6npw.css">
    <meta name="author" content="Brian Evans">
    <link rel="stylesheet" href="currentCalcStyles.css"/>
    <title><?= $pageName ?></title>
    <meta name="keywords" content="<?= $pageName ?>">
    <meta name="description" content="This is calculator to work out the scale of your current meter in Betaflight from measured amps drawn and amps charged">
