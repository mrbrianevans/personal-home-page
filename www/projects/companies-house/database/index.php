...
ini_set("max_execution_time", 0); // unlimited run time
//include($_SERVER['DOCUMENT_ROOT'] . "/visit.php");
$pageName = "Companies house database";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="../companiesHouseStyles.css" type="text/css"/>
    <link rel="stylesheet" href="companyDashboardStyles.css" type="text/css"/>
    <script src="searchPredictions.js"></script>

    <title><?= $pageName ?></title>
    <meta name="keywords" content="<?= $pageName ?>">
    <meta name="description" content="Saves data from companies house to allow better search">
