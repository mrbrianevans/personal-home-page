...
$pageName = "T9 Mobile Keypad Autocomplete Predictive Text";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <meta name="description" content="In this project I show how autocomplete worked on old phones with the 9-key keypad">
