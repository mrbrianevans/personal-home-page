...
<head>
    ...
    <script src="fpv.js"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://use.typekit.net/rwv6npw.css">
    <link rel="stylesheet" href="quadcopterStyle.css">
    <meta name="author" content="Brian Evans">


    <title>QuadMngr</title>
    <meta name="keywords" content="fpv, quadcopter, drone, powerloops, long range">
    <meta name="description" content="This tool offers insights into your FPV quadcopter and what you could do to boost performance">

</head>

<body onload="pageLoad()">
<header><a href="index.php" style="text-decoration: none"><h1 class="orange" id="brian">QuadMngr</h1></a></header>
<div class="mainbody">
    <div class="singlebox">
