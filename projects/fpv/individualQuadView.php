...
<div id="panel<?=$quad["id"]?>" class="quadPanel <?=$built?>">
    ...
    $eventArrows = str_replace("onclick=\"\"", "onclick=\"displayDetails('".$quad["id"]."')\"", $taggedArrows);
    echo $eventArrows;
    ...
    <div class="componentsContainer">
        ...
        <div>
            ...
            <div class="quadComponentText" id="esc<?=$quad["id"]?>">
                ...
                <meter value="<?=$quad["esc_amps"]?>" min="<?=$classESCMin?>" max="<?=$classESCMax?>" optimum="<?=$classESCOpt?>"></meter>
            </div>
            <div class="quadComponentText" id="flightController<?=$quad["id"]?>">
                <?= $quad["flight_controller"] . ""?>
                <meter value="<?=$flightControllerNumber?>" min="1" max="7" optimum="6" low="3" high="5"></meter>
            </div>
