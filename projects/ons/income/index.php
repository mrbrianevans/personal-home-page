...
$pageName = "Income statistics from the ONS";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <script src="/frontend.js" type="text/javascript" rel="script"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://use.typekit.net/rwv6npw.css">
    <meta name="author" content="Brian Evans">
    <script src="/googleChartsLocal.js" type="text/javascript" rel="script"></script>
    <script src="incomeGrapher.js" type="text/javascript" rel="script"></script>

    <title><?= $pageName ?></title>
    <meta name="keywords" content="<?= $pageName ?>">
    <meta name="description" content="An analysis of incomes in England">
