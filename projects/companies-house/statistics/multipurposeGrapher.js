...
google.charts.setOnLoadCallback(addEventListeners);
function addEventListeners (){
    document.getElementById("pscButton").addEventListener("click", graphPsc);
    console.log("Event listeners active. Buttons should be functional now");
}
function graphPsc() {
    console.log("Drawing graph of PSC ages");
