...
$pageName = "Home schooling dashboard";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <script type="text/babel" src="reactDashboard.jsx"></script>

    <title><?= $pageName ?></title>
    <meta name="keywords" content="<?= $pageName ?>">
    <meta name="description"
          content="A place to manage your homeschooling journey. Plan out the content you aim to cover, and then track your progress throughout the year">
