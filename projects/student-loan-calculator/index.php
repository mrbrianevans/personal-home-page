...
$pageName = "Student Loan Payback calculator";
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <meta name="description" content="In this project, I graph how long it would take to pay back a student loan, depending on how much you earn in your career">
...
<div class="mainbody">
    <div class="singlebox">
        ...
        ?>
        Graph of student loan outstanding over time
    </div>
